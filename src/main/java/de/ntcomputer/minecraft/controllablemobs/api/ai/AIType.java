...
import net.minecraft.server.v1_7_R3.PathfinderGoalBeg;
import net.minecraft.server.v1_7_R3.PathfinderGoalBreakDoor;
import net.minecraft.server.v1_7_R3.PathfinderGoalBreed;
import net.minecraft.server.v1_7_R3.PathfinderGoalDefendVillage;
...
import net.minecraft.server.v1_7_R3.PathfinderGoalInteract;
...
import net.minecraft.server.v1_7_R3.PathfinderGoalMakeLove;
...
import net.minecraft.server.v1_7_R3.PathfinderGoalOfferFlower;
import net.minecraft.server.v1_7_R3.PathfinderGoalOpenDoor;
import net.minecraft.server.v1_7_R3.PathfinderGoalOwnerHurtByTarget;
import net.minecraft.server.v1_7_R3.PathfinderGoalOwnerHurtTarget;
...
import net.minecraft.server.v1_7_R3.PathfinderGoalPlay;
...
import net.minecraft.server.v1_7_R3.PathfinderGoalSwell;
import net.minecraft.server.v1_7_R3.PathfinderGoalTakeFlower;
