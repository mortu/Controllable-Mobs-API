...
public class CraftAttributeModifier implements AttributeModifier {
	...
	private net.minecraft.server.v1_7_R3.AttributeModifier nativeModifier = null;
	...
	public CraftAttributeModifier(UUID uuid, net.minecraft.server.v1_7_R3.AttributeModifier nativeModifier) {
		this.uniqueID = uuid;
	...
	net.minecraft.server.v1_7_R3.AttributeModifier getNativeModifier() {
		if(this.nativeModifier==null) {
			this.nativeModifier = new net.minecraft.server.v1_7_R3.AttributeModifier(uniqueID, name, value, this.operation.getIntType());
		}
